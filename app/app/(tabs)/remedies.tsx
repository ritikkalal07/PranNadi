...
const CROP_FILTERS: Array<{ key: CropType | 'all'; label: string }> = [
  ...
  { key: 'apple', label: 'crops.apple' },
  { key: 'blueberry', label: 'crops.blueberry' },
  { key: 'cherry', label: 'crops.cherry' },
  { key: 'grape', label: 'crops.grape' },
  { key: 'maize', label: 'crops.maize' },
  { key: 'orange', label: 'crops.orange' },
  { key: 'peach', label: 'crops.peach' },
  { key: 'pepper', label: 'crops.pepper' },
  { key: 'potato', label: 'crops.potato' },
  { key: 'raspberry', label: 'crops.raspberry' },
  { key: 'soybean', label: 'crops.soybean' },
  { key: 'squash', label: 'crops.squash' },
  { key: 'strawberry', label: 'crops.strawberry' },
